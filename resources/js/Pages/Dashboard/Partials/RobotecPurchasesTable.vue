...
<template>
    ...
    <Modal :show="transactionModal" :title="$t('public.purchase_details')" @close="closeModal" max-width="sm">
        <div v-if="transactionDetails">
            ...
            <div class="grid grid-cols-2 items-center">
                <div class="col-span-1 text-gray-300 text-xs font-normal font-sans leading-[18px]">{{ $t('public.amount') }}</div>
