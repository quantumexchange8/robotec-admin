        ...
        <div v-if="transactionDetails">
            <div class="w-full justify-start items-center gap-3 inline-flex">
                ...
                <div class="w-full flex-col justify-start items-start inline-flex">
                    <div class="self-stretch text-white font-medium break-all">{{ transactionDetails.user.name }}</div>
            ...
            <div class="grid grid-cols-2 items-center mb-2">
                ...
                <div class="col-span-1 text-white text-sm font-medium break-all">{{ transactionDetails.transaction_number }}</div>
            </div>
            <div class="grid grid-cols-2 items-center mb-2">
            ...
            <div class="grid grid-cols-2 items-center">
                <div class="col-span-1 text-gray-300 text-xs">{{ $t('public.deposit_amount') }}</div>
            ...
            <div class="grid grid-cols-2 items-center">
                <div class="col-span-1 text-gray-300 text-xs">
