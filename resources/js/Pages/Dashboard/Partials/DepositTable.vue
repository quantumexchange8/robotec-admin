...
<template>
    ...
    <Modal :show="transactionModal" title="Deposit Details" @close="closeModal" max-width="sm">
        <div v-if="transactionDetails">
            ...
            <div class="grid grid-cols-2 items-center">
                <div class="col-span-1 text-gray-300 text-xs font-normal font-sans leading-[18px]">Deposit Amount</div>
