                    ...
                    <tr v-for="transaction in transactions.data" :key="transaction.id" class="py-2 bg-gray-800 text-xs font-normal border-b border-gray-700" @click="openModal(transaction)">
                        <td>
                            <div class="flex justify-between items-center gap-3">
                                ...
                                <div class="text-success-500 text-right text-md font-medium font-sans leading-normal">$ {{ transaction.transaction_amount }}</div>
                            </div>
                        </td>
                    </tr>
                </tbody>
    ...
    <Modal :show="transactionModal" :title="$t('public.deposit_details')" @close="closeModal" max-width="sm">
        <div v-if="transactionDetails">
            ...
            <div class="grid grid-cols-2 items-center mb-2">
                ...
                <div class="col-span-1 text-white text-xs font-normal font-sans leading-tight">{{ transactionDetails.id }}</div>
            </div>
            <div class="grid grid-cols-2 items-center mb-2">
            ...
            <div class="grid grid-cols-2 items-center">
                <div class="col-span-1 text-gray-300 text-xs font-normal font-sans leading-[18px]">{{ $t('public.deposit_amount') }}</div>
            ...
            <div class="grid grid-cols-2 items-center mb-2">
                <div class="col-span-1 text-gray-300 text-xs font-normal font-sans leading-[18px]">{{ $t('public.transaction_number') }}</div>
